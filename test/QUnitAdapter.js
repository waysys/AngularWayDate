        ...
        QUnitTestCase.prototype['test ' + name] = (function (lifecycle) {
            return function (q) {
                ...
                window.stop = function () {
                    ...
                    window.ok = function () {
                        capturedAssertions.push(['ok', arguments])
                    };
                    window.equal = function () {
                        capturedAssertions.push(['equal', arguments])
                    };
                    window.notEqual = function () {
                        capturedAssertions.push(['notEqual', arguments])
                    };
                    window.deepEqual = function () {
                        capturedAssertions.push(['deepEqual', arguments])
                    };
                    window.notDeepEqual = function () {
                        capturedAssertions.push(['notDeepEqual', arguments])
                    };
                    window.strictEqual = function () {
                        capturedAssertions.push(['strictEqual', arguments])
                    };
                    window.notStrictEqual = function () {
                        capturedAssertions.push(['notStrictEqual', arguments])
                    };
                    window.raises = function () {
                        capturedAssertions.push(['raises', arguments])
                    };
